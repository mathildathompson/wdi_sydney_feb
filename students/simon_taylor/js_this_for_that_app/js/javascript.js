...
var randomThis = function() {
  var text = _this[Math.floor(Math.random()*_this.length)];
  return text;
};

var randomThat = function() {
  var text = _that[Math.floor(Math.random()*_that.length)];
  return text;
};

var startupIdea = function() {
  var output = "So.... your startup is basically like a like a " + randomThis() + " for " + randomThat() + "?";
  console.log(output);
};

var output = function () {
    ...
    var randomThis = function () {
        ...
        first = "So.... your startup is basically like a like a " + _this[Math.round(Math.random()*(_this.length-1))];
    ...
    var randomThat = function () {
        ...
        second = " for " + _that[Math.round(Math.random()*(_that.length-1))];
    ...
    var endResult = randomThis() + randomThat();
        return endResult;
};

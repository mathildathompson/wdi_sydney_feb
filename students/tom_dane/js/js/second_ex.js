...
var fortune = function(children,name,place,title) {
        console.log("You will be a " + title + " in " + place + ", and married to " + name + " with " + children + " kids.");
}
fortune(5,'Michelle','Cali','Web Developer')
fortune(4,'Mike','Cali Colombia','Web Developer')
fortune(2,'Michellen','Cali','Train Developer')
...
var calculateAge = function(birth_year,year) {

    console.log("You are either " + (year - birth_year) + ' or ' + (year - birth_year - 1))
}
...
var calculateSupply = function(age,amount) {
    ...
    var max_age = 34
    console.log("You will need " + ((max_age - age)*amount*365) + ' to last you until ' + max_age);

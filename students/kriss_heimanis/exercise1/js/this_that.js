...
We're going to recreate a console version of this site. What does your startup do? Let's practice using arrays to find out!
...
var randomThis = _this[Math.floor(Math.random() * _this.length)];
var randomThat = _that[Math.floor(Math.random() * _that.length)];

console.log("so basically your startup is a");
console.log(randomThis);
console.log("for");
console.log(randomThat);